...
//Current_Book_Index _Variable
int currentIndex = 0;

//Library_Capacity_Variable
int capacity = 0;

//Auto-increment_ID_Variable
int nextID = 1;



//Generic_Info_Initialization_Function
...
void infoExpand(Ty*& info) {
	...
	int copyCount = (currentIndex < capacity) ? currentIndex : capacity;
